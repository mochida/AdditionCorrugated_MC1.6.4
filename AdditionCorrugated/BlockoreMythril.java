...
public class BlockoreMythril extends Block
{
	
	public BlockoreMythril(int par1, Material par2Material)
	{
		super(par1, par2Material);
		this.setUnlocalizedName("oreMythril");
		this.setTextureName("additioncorrugated:block_oremythril");
