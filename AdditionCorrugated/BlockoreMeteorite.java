...
public class BlockoreMeteorite extends Block
{
	
	public BlockoreMeteorite(int par1, Material par2Material)
	{
		super(par1, par2Material);
		this.setUnlocalizedName("oreMeteorite");
		this.setTextureName("additioncorrugated:block_oremeteorite");
