...
public class BlockoreAdamantite extends Block
{
	
	public BlockoreAdamantite(int par1, Material par2Material)
	{
		super(par1, par2Material);
		this.setUnlocalizedName("oreAdamantite");
		this.setTextureName("additioncorrugated:block_oreadamantite");
