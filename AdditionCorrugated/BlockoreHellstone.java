...
public class BlockoreHellstone extends Block
{
	
	public BlockoreHellstone(int par1, Material par2Material)
	{
		super(par1, par2Material);
		this.setUnlocalizedName("oreHellstone");
		this.setTextureName("additioncorrugated:block_orehellstone");
